...
//This is the View for the deposit screen
public class ATMViewDeposit extends JFrame {
        ...
        JFrame appFrameDeposit = new JFrame();
        ...
        JLabel instr = new JLabel("Enter deposit amount");
        ...
        public void createGUIDeposit(){
        
            appFrameDeposit.setSize(1000,1000);
            appFrameDeposit.setVisible(true);
            appFrameDeposit.setDefaultCloseOperation(EXIT_ON_CLOSE);
            appFrameDeposit.setLocationRelativeTo(null);
            appFrameDeposit.setLayout(new GridLayout(4,5));
            ...
            ATMControllerDeposit listener = new ATMControllerDeposit();
            ...
            appFrameDeposit.add(instructions);
            appFrameDeposit.add(balancePanel);
            appFrameDeposit.add(input);
            appFrameDeposit.add(keyPad);

        }
        
        //Controller subclass for Deposit View
        public class ATMControllerDeposit implements ActionListener{
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (e.getSource() == one){
                    ...
                    //Makes sure number is more than 0 and less than 1000
                    if (Integer.valueOf(PIN.getText()) > 0 && Integer.valueOf(PIN.getText()) < 1000){
                    
                        //Set deposit amount to the number typed by the user
                        depositAmount = Integer.valueOf(PIN.getText());
                    
                        //Notifies user of amount deposited
                        instr.setText("£"+depositAmount+" deposited");  
                    ...
                    //Else notify user invalid amount
                    } else instr.setText("Invalid deposit amount - Please try again");
                    PIN.setText("");
