...
public class ATMDepositController {
	...
	private ATMDepositModel model;
	private ATMViewDeposit view;
    private ActionListener actionListener;
    
	public ATMDepositController(ATMDepositModel model, ATMViewDeposit view)
	{
		this.model = model;
		this.view = view;
	}
	...
	public void control()
	{
        ...
        if (e.getSource() == view.one){
            ...
            if (Integer.valueOf(view.PIN.getText()) > 0 && 
            		Integer.valueOf(view.PIN.getText()) < 1000){
            
                //Set deposit amount to the number typed by the user
                model.setDeposit(Integer.valueOf(view.PIN.getText()));
            
                //Notifies user of amount deposited
                view.instr.setText("£" + model.getDeposit() + " deposited");  
            ...
            } else view.instr.setText("Invalid deposit amount - Please try again");
            view.PIN.setText("");
